...
const es: Content = {
  ...
  features: {
    ...
    items: [
      ...
      { title: "Proyectos y favoritos", body: "Cada análisis se guarda en tu historial, con favoritos.", glow: "var(--color-ink-crimson)" },
      { title: "Mis tintas (Pro)", body: "Lleva el inventario de los botes que realmente tienes.", glow: "var(--color-ink-violet)" },
      { title: "Hecho para tablet", body: "Vista dividida: tu diseño y su paleta a la vez.", glow: "var(--color-ink-teal)" },
    ],
  },
  brands: {
